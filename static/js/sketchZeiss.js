...
function preload() {
  eixo = loadModel("static/assets/zeiss/eixo.obj", false)
  tubo = loadModel("static/assets/zeiss/tubo.obj", false)
  base = loadModel("static/assets/zeiss/pilar.obj", false)
...
function draw() {
  ...
  scale(.14)
  // normalMaterial()
  fill(79, 92, 106) // Atribui cor ao modelo  
  ...
  translate(-10, 0, 155) //Offset para coincidir os pivôs da base e do eixo

  strokeWeight(.1)
  model(eixo)
  translate(-486, -25, 0) //Offset para coincidir os pivôs do eixo e do tubo
